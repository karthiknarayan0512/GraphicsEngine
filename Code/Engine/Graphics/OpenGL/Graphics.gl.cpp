...
namespace
{
	...
	bool CreateVertexBuffer()
	{
		...
		// Assign the data to the buffer
		{
			...
			const unsigned int noOfTriangles = 2;
			const unsigned int vertexCount = verticesPerTriangle * noOfTriangles;
			...
			glBufferData( GL_ARRAY_BUFFER, sizeof( sVertex ) * vertexCount, reinterpret_cast<GLvoid*>( vertexData ),
