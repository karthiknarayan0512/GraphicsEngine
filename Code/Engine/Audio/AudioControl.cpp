...
namespace eae6320
{
	...
	void Audio::SetVolume(float currentDistance, float maxDistance, float minDistance)
	{
		if (currentDistance > maxDistance)
			s_SourceVoices[s_CurrentPlayingAudio]->SetVolume(0.0f);
		else if (currentDistance < maxDistance)
			s_SourceVoices[s_CurrentPlayingAudio]->SetVolume(1.0f);
		else
		{
			s_SourceVoices[s_CurrentPlayingAudio]->SetVolume((maxDistance - currentDistance) / maxDistance);
		}
	}
